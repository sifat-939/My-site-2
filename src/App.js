...
const USER_DATA = {
  ...
  languages: [
    ...
    { name: "English", level: "Level B2 (Fluent Communication)", percent: 85 },
    ...
    >
      ...
      >
        ...
        <footer className="p-6 text-center text-[10px] font-bold opacity-30 tracking-widest uppercase">
          {t.available} — 2026 Personal Brand
        </footer>
      </motion.div>
    </div>
  );
  ...
  >
    ...
    <div className="max-w-xl space-y-4">
      ...
      <p className="text-sm md:text-base font-medium opacity-60 max-w-md mx-auto leading-relaxed">
        Multifaceted professional focused on healthcare excellence in Germany,
        creative storytelling, and cultural exploration.
      </p>
    </div>
  </motion.div>
);
...
const ContactView = ({ t, isDark }) => (
  ...
  >
    <div className="text-center mb-10">
      ...
      <h2 className="text-3xl font-black tracking-tight">{t.contact}</h2>
      <p className="text-xs font-bold opacity-40 uppercase tracking-widest mt-2">
        sifatullah.contact@gmail.com
      </p>
    </div>
    ...
    {/* IMPORTANT: Remember to update the Formspree action link below with your own from formspree.io */}
    <form
